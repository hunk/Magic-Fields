...
define('MF_FILES_PATH', WP_CONTENT_DIR.DIRECTORY_SEPARATOR.MF_FILES_NAME.DIRECTORY_SEPARATOR);


define('MF_FILES_URI', WP_CONTENT_URL.DIRECTORY_SEPARATOR.MF_FILES_NAME.DIRECTORY_SEPARATOR);


define('MF_UPLOAD_FILES_DIR', MF_FILES_PATH);

define('MF_IMAGES_CACHE_DIR',
