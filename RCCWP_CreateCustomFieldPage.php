...
class RCCWP_CreateCustomFieldPage
{
	...
	function SetOptions()
	{
		...
		<tr valign="top">
			...
			<td><select name="custom-field-related-type-panel-id" id="custom-field-related-type-panel-id">
				<option value="-2">All Post/Page</option>
				<option value="-1">All With Panels</option>
	...
	function AddAjaxDynamicList(){
		if(!empty($_GET['mf_action']) && $_GET['mf_action']=='create-custom-field'){
			...
			<script type="text/javascript" src="<?php echo MF_URI?>js/ajax-dynamic-list/ajax.js"></script>
			<script type="text/javascript" src="<?php echo MF_URI?>js/ajax-dynamic-list/ajax-dynamic-list.js">
			/************************************************************************************************************
