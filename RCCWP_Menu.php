    	  ...
    	  $page_new    = "post-new.php?post_type=page&";
			...
			foreach ($customWritePanels as $panel){
				...
				if(!$condence){
					...
					$new_menu[$base+$offset] = array( __($panel->name), $type_write_panel, $base+$offset.'.php', '', 'wp-menu-open menu-top mf-menu-'.$type_write_panel, 'mf-menu-'.$panel->capability_name, 'div' );
