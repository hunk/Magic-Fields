...
class RCCWP_Menu
{
	...
	function AttachMagicFieldsMenus()
	{
		...
		// Add top menu
		add_menu_page(__('Magic Fields > Manage',$mf_domain), __('Magic Fields',$mf_domain), 'edit_pages', 'MagicFieldsMenu', $panelsAndModulesFunctions->panelsMenuFunction, plugins_url('magic-fields/images/wand-hat.png'));
